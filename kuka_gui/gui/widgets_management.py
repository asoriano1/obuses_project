...
class WidgetsManagement(object):
    ...
    def select_icon(self,operation, obus_id, state):        
        ...
        if calibre == 2:
            return global_var.imgObus2[state]
        elif calibre == 4:
            return global_var.imgObus4[state]
        elif calibre == 8:
            if operation == 'pick':
                if num < 8:
                    return global_var.imgObus8izq[state]                    
                if num >= 8:
                    return global_var.imgObus8der[state]
            ...
            if operation == 'pick':
                if num < 11:
                    return global_var.imgObus16izq[state]
                elif num >= 11:
                    return global_var.imgObus16der[state]
            elif operation == 'place':
                if num < 9:
                    return global_var.imgObus16izq[state]
                elif num >= 9:
    ...
    def press_pick_obus2_1_button(self):
        self.obus_manager.press_obus_button('pick', 2, 1,
            side='right',
            pre_z=global_var.Prepick_Pose_z,
            axis_service=global_var.srv_move_A1_A6,
            axis_args=(obuses_poses.pick_A1, obuses_poses.pick_right_A6)
        )
    ...
    def press_pick_obus2_3_button(self):
        self.obus_manager.press_obus_button('pick', 2, 3,
            ...
            pre_z=global_var.Prepick_Pose_z,
            axis_service=global_var.srv_move_A1_A6,
            axis_args=(obuses_poses.pick_A1, obuses_poses.pick_left_A6)
        )        
    ...
    def press_place_obus2_1_button(self):
        self.obus_manager.press_obus_button(
            'place', 2, 1,
            side='right',
            pre_z=global_var.Preplace_Pose_z,
            axis_service=global_var.srv_move_A1_A6,
            axis_args=(obuses_poses.place_A1, obuses_poses.place_right_A6)
        )
    ...
    def press_place_obus2_2_button(self):
        self.obus_manager.press_obus_button(
            ...
            pre_z=global_var.Preplace_Pose_z,
            axis_service=global_var.srv_move_A1_A6,
            axis_args=(obuses_poses.place_A1, obuses_poses.place_left_A6)
        )
